	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 main">
				...
				<table id="idData"
					class="table table-bordered table-hover table-striped user-list">
					...
					<c:forEach items="${listUser}" var="a">
						<tr class="a">
							<c:if test="${a.isExist=='1'}">
								...
								<td><a class="modify" href="javascript:void(0)"><button
											class="btn btn-sm">修改资料</button></a> | <a
									href="/deleteUser/${a.userName}" class="del"><button
											class="btn btn-sm">删除用户</button></a></td>
				...
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><input name="accountName"
							class="accountName  form-control" maxlength="20" /></td>
					</tr>
					...
					<tr>
						...
						<td><input name="email" type="email"
							class="email  form-control" maxlength="20" /></td>
					</tr>
					<tr>
						<td>电话</td>
